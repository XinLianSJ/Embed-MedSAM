...
from lightweight_sam.build_efficient_sam import sam_model_registry
from lightweight_sam.predictor import SamPredictor 
from lightweight_sam.automatic_mask_generator import SamAutomaticMaskGenerator
...
class Model(nn.Module):
    ...
    def get_checkpoint(self, model_type):
        if model_type == "vit_t":
            checkpoint = os.path.join(self.cfg.model.checkpoint, "efficient_sam_vitt.pth")
        elif model_type == "vit_s":
            checkpoint = os.path.join(self.cfg.model.checkpoint, "efficient_sam_vits.pth")
        else:
